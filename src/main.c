...
void update(void) {
  ...
  for (int i = 0; i < array_length(mesh.faces); i++) {
    ...
    if (render_centroids || render_normals || render_back_faces == false) {
